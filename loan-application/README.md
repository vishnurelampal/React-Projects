1. Requirement gathered 
2. Project installation and setup done
3. Different component for each stepper created
4. DropwDown and Input label component created
5. Utlis added
6. Validation setup
7. Yup setting up
